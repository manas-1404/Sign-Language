...
/**
 * Interactive tier-2 phrase practice UI.
 *
...
interface Tier2PracticeProps {
  videoUrls: Record<string, string>;
}

export default function Tier2Practice({ videoUrls }: Tier2PracticeProps) {
  ...
  const currentVideoUrl = videoUrls[currentPhrase.videoSlug];

  return (
    <main className="min-h-screen bg-gradient-to-br from-slate-900 via-violet-950 to-slate-900 text-white p-4 md:p-6">
      <div className="max-w-7xl mx-auto flex flex-col gap-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 items-start">
          {/* Left column: phrase prompt + webcam + controls */}
          <div className="flex flex-col gap-3">
            <PhrasePrompt
          ...
          <div className="flex flex-col gap-3">
            {currentVideoUrl && (
              <SignVideoPlayer
                ...
                attributionSlug={currentPhrase.videoSlug}
              />
            )}
          </div>
        </div>
